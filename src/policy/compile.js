...
import { buildOnchainPolicy, emitCompiledPolicy, emitToken } from '../onchain/policy.js';
import { compileCondition, evaluateTerms } from './dnf.js';
import { resolveComponents, PROFILES } from '../onchain/components.js';
import { validateCashier, bindCashierClauses, emitCashierTerms } from '../onchain/cashier.js';
...
export function compilePolicy(envelope, config, document, { demo = false } = {}) {
  ...
  const solidity = emitToken(policy);
