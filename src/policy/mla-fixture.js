...
export function mlaFixture(document) {
  ...
  const ast = {
    ...
    terms: [
      ...
      term('buybackCeiling', '1.00', 'asset per market token', 'Addendum A1.5',
        'up to a ceiling of 1.00 units of the Digital Asset To Be Loaned per Market Token',
        'The most the borrower will pay when it runs the offer as an improving auction.'),
      term('buybackWindowHours', '6', 'hours', 'Addendum A1.5',
        'improve it over a window of not more than six (6) hours',
        'The auction window over which the price improves from the floor to the ceiling.'),
