...
import { demoWorkspaceRoutes } from './demo-workspaces.js';
import { investorRoutes } from './investor-api.js';
...
export function createApp(service, apiKey, venues = null, policyData = null, viewerKey = null, agreements = null, { paymentSecret = process.env.PAYMENT_WEBHOOK_SECRET ?? null, signing = null, demoWorkspaces = null, investor = null } = {}) {
  ...
  if (demoWorkspaces) app.use('/v1', demoWorkspaceRoutes(demoWorkspaces, () => stackStatus(venues)));
  if (investor) app.use('/v1/investor', investorRoutes(investor));
