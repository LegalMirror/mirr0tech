...
export const schemas = {
  ...
  Agreement: obj({
    ...
    extraction: { type: ['object', 'null'], properties: { provider: str('openai | demo'), model: str('Model id'), responseId: str('OpenAI response id') } },
