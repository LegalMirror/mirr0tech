...
export function sampleFixture(document, { secondary = false } = {}) {
  ...
  const ast = {
    ...
    rules: [
      ...
      rule('mint-proof-of-human', 'mint', 'require', fact('humanVerified'), 'Exhibit A — Investor Onboarding',
        ...
        'KYC starts with a person. A World ID proof of human, verified and bound to the wallet, satisfies the identity step; its nullifier keeps one person from onboarding twice.'),
      ...(secondary ? [
        rule('transfer-proof-of-human', 'transfer', 'require', fact('humanVerified'), 'Exhibit A — Investor Onboarding',
          'perform Know-your-customer (KYC), Know-your-business (KYB), Anti-Money Laundering (AML), and sanctions checks during onboarding of investors',
          'A wallet at the venue must belong to a verified human before it may hold or move shares.'),
